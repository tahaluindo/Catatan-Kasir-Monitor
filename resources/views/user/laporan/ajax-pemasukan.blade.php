...
<h1 style="font-family: 'Bakso Sapi'">Pemasukan</h1><hr>
@if($totalPemasukan > 0)
    <canvas id="chart_pemasukan" height="40vh" width="80vw"></canvas>
...
@else
<h3>Tidak ada transaksi pemasukan</h3>
@endif
@endif

<script>
    var ct1 = document.getElementById('chart_pemasukan').getContext('2d');
